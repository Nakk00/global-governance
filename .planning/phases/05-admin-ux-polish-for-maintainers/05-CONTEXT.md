...
### Visual Assets and Responsiveness
- **D-12:** Use `archive/images/Admin-Background.png` as the atmospheric
  background reference for the control center.
- **D-13:** Use `archive/images/Admin-Logo.png` as the top-right brand mark for
  the private admin shell.
- **D-14:** The Phase 5 control center must support mobile layouts with a
  compact navigation pattern and stacked content blocks.
