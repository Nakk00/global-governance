...
- Keep the guide beginner-friendly, action-first, and explicit about what to click, inspect, fix, and confirm.
...
- Use exact UI labels and keep diagnosis pages separate from repair pages.
- Do not treat synthetic dashboard values or context-free `Pending` labels as authoritative.
