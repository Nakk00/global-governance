...
3. User-selected depth is reflected in chat context where supported and falls back safely where not yet specialized
...
- [ ] 01-03: Thread depth context through chat requests, fallbacks, and verification coverage
...
Plans:
- [ ] 02-01: Standardize trust-state UX, copy, and source-support patterns across learner surfaces
