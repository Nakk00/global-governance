...
export function HeroNarrativeFrame({ content, id }: HeroNarrativeFrameProps) {
  ...
  return (
    <section
      ...
      className="editorial-section relative isolate flex min-h-svh overflow-hidden px-5 py-8 sm:px-8 lg:px-12"
    ...
    >
      ...
      />
      <div className="editorial-container grid content-center gap-8 md:grid-cols-[minmax(0,1.05fr)_minmax(18rem,0.72fr)] md:items-center">
        <div className="editorial-surface orbital-hero-panel editorial-measure relative space-y-6 overflow-hidden rounded-[2rem] p-8 sm:p-10 lg:p-12">
          ...
          <Button
            asChild
            size="lg"
            className="editorial-primary-action text-sm sm:text-base"
          >
            <a
              href={targetHref}
            ...
            <div className="space-y-4">
              ...
              <div className="grid gap-3 text-sm text-muted-foreground">
                <p className="flex items-center gap-3">
                  <span className="orbital-rail-marker size-6 text-[0.65rem]">1</span>
                  Entry vector
                </p>
                <p className="flex items-center gap-3">
                  <span className="orbital-rail-marker size-6 text-[0.65rem]">2</span>
                  Institutional gravity
                </p>
                <p className="flex items-center gap-3">
                  <span className="orbital-rail-marker size-6 text-[0.65rem]">3</span>
                  Regional collision
                </p>
              </div>
            </div>
