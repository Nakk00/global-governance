...
```
Task(
  prompt="Read C:/Users/Nakko/Desktop/VSCode-ProjectFiles/Global-Governance/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/Nakko/Desktop/VSCode-ProjectFiles/Global-Governance/.codex/get-shit-done/templates/VALIDATION.md`
