...
- **Global scope**: `C:/Users/Nakko/Desktop/VSCode-ProjectFiles/Global-Governance/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/Nakko/Desktop/VSCode-ProjectFiles/Global-Governance/.codex/notes/`)
...
2. Glob `C:/Users/Nakko/Desktop/VSCode-ProjectFiles/Global-Governance/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/Nakko/Desktop/VSCode-ProjectFiles/Global-Governance/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/Nakko/Desktop/VSCode-ProjectFiles/Global-Governance/.codex/notes/` — works in any directory
