...
The keys live in `.codex/settings.json` (project) or `C:/Users/Nakko/Desktop/VSCode-ProjectFiles/Global-Governance/.codex/settings.json` (global) — **not** in `.planning/config.json`:
